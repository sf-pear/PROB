...
#     --exemplar_replay_prev_file "task2_train_ft.txt" --exemplar_replay_cur_file "task3_train_ft.txt"\
...
#     --train_set "${WANDB_NAME}/task3_train_ft" --test_set 'all_test' --epochs 181 --lr_drop 35\
#     --model_type 'prob' --obj_loss_coef 8e-4 --obj_temp 1.3\
...
#     --exemplar_replay_prev_file "task3_train_ft.txt" --exemplar_replay_cur_file "task4_train_ft.txt"\
...
#     --train_set "${WANDB_NAME}/task4_train_ft" --test_set 'all_test' --epochs 261 --lr_drop 50\
#     --model_type 'prob' --obj_loss_coef 8e-4 --obj_temp 1.3\
